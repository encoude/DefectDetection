...
class TrainingWorker(QThread):
    ...
    def run(self):
        try:
            ...
            # 调用 Train_Model.train_model 进行训练
            # 注意：确保 Train_Model.train_model 使用传入的 num_epochs 而非硬编码数值
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.epochLineEdit.setText("50")  # 默认训练 50 轮（确保 Train_Model.train_model 使用该参数）
